...
public class GameServiceImpl implements GameService {
  ...
  public Collection<Game> listLast10() {
    ...
    return gameRepo.findByStateNotOrderByStartedOnDesc(GameState.ONGOING);
  }

  public void finishOldGames(){
    gameRepo.findByStateAndStartedOnBefore(GameState.ONGOING, LocalDateTime.now().minusDays(1)).forEach(w->w.setState(GameState.LOSS));
  }
}
